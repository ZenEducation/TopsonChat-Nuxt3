                ...
                <div class="chat-box border-theme-5 col-span-12 xl:col-span-6 flex flex-col overflow-hidden xl:border-l xl:border-r p-6">
                                ...
                                <div>
                                    <div class="chat-text-box__content flex items-center float-left">
                                        ...
                                        <div class="hidden sm:block dropdown relative ml-3 mt-3">
                                            <a href="javascript:;" class="dropdown-toggle w-4 h-4"> <i data-feather="more-vertical" class="w-4 h-4"></i> </a>
                                            <div class="dropdown-menu w-40">
                                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                                    <a href="" class="flex items-center p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="corner-up-left" class="w-4 h-4 mr-2"></i> Reply </a>
                                                    <a href="" class="flex items-center p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="trash" class="w-4 h-4 mr-2"></i> Delete </a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="chat-text-box__content flex items-center float-left">
                                        <div class="box text-gray-700 dark:text-gray-300 flex flex-col sm:flex-row items-center mt-3 p-3">
                                            ...
                                            <div class="sm:ml-20 mt-3 sm:mt-0 flex">
                                                <a href="javascript:;" title="Download" class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center sm:ml-2"> <i data-feather="download" class="w-4 h-4"></i> </a>
                                                <a href="javascript:;" title="Share" class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center ml-2"> <i data-feather="share" class="w-4 h-4"></i> </a>
                                                <a href="javascript:;" title="Permission" class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center ml-2"> <i data-feather="more-horizontal" class="w-4 h-4"></i> </a>
                                            </div>
                                        </div>
                                        <div class="hidden sm:block dropdown relative ml-3 mt-3">
                                            <a href="javascript:;" class="dropdown-toggle w-4 h-4"> <i data-feather="more-vertical" class="w-4 h-4"></i> </a>
                                ...
                                <div>
                                    ...
                                    <div class="chat-text-box__content flex items-center float-right">
                                        ...
                                        <div class="rounded-md text-gray-700 chat-text-box__content__text--image flex justify-end mt-3">
                                            <div class="tooltip w-16 h-16 image-fit zoom-in" title="preview-4.jpg">
                                                <img alt="Topson Messenger Tailwind HTML Admin Template" class="rounded-md" src="dist/images/preview-4.jpg">
                                            </div>
                                            <div class="tooltip w-16 h-16 image-fit ml-2 zoom-in" title="preview-4.jpg">
                                ...
                                <div>
                                    ...
                                    <div class="chat-text-box__content flex items-center float-left">
                                        <div class="rounded-md text-gray-700 chat-text-box__content__text--image flex justify-end mt-3">
                                            ...
                                            <div class="tooltip w-16 h-16 image-fit ml-2 zoom-in" title="preview-12.jpg">
                                                <img alt="Topson Messenger Tailwind HTML Admin Template" class="rounded-md" src="dist/images/preview-12.jpg">
                                            </div>
                                        </div>
                                        <div class="hidden sm:block dropdown relative ml-3 mt-3">
                                ...
                                <div>
                                    ...
                                    <div class="chat-text-box__content flex items-center float-right">
                                        ...
                                        <div class="box leading-relaxed text-gray-700 dark:text-gray-300 flex flex-col sm:flex-row items-center mt-3 p-3">
                                            ...
                                            <div class="sm:ml-20 mt-3 sm:mt-0 flex">
                                                <a href="javascript:;" title="Download" class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center ml-2"> <i data-feather="download" class="w-4 h-4"></i> </a>
                                                <a href="javascript:;" title="Share" class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center ml-2"> <i data-feather="share" class="w-4 h-4"></i> </a>
                                                <a href="javascript:;" title="Permission" class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center ml-2"> <i data-feather="more-horizontal" class="w-4 h-4"></i> </a>
                                            </div>
                                        </div>
                    ...
                    <div class="intro-y chat-input box border-theme-3 dark:bg-dark-2 dark:border-dark-2 border flex items-center px-5 py-4">
                        ...
                        <div class="dropdown relative" data-placement="top">
                            <a href="javascript:;" class="text-gray-600 hover:text-theme-1 dropdown-toggle"> <i data-feather="plus" class="w-5 h-5 sm:w-6 sm:h-6"></i> </a>
                            <div class="chat-input__dropdown dropdown-menu">
                                <div class="dropdown-menu__content p-2">
                                    <a href="" class="shadow-md text-gray-600 bg-white rounded-full dark:text-gray-300 dark:bg-dark-3 hover:bg-theme-1 hover:text-white dark:hover:bg-theme-1 flex items-center block p-3 transition duration-300 rounded-md mb-2"> <i data-feather="camera" class="w-5 h-5"></i> </a>
                                    <a href="" class="shadow-md text-gray-600 bg-white rounded-full dark:text-gray-300 dark:bg-dark-3 hover:bg-theme-1 hover:text-white dark:hover:bg-theme-1 flex items-center block p-3 transition duration-300 rounded-md mb-2"> <i data-feather="mic" class="w-5 h-5"></i> </a>
                                    <a href="" class="shadow-md text-gray-600 bg-white rounded-full dark:text-gray-300 dark:bg-dark-3 hover:bg-theme-1 hover:text-white dark:hover:bg-theme-1 flex items-center block p-3 transition duration-300 rounded-md mb-2"> <i data-feather="mail" class="w-5 h-5"></i> </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dropdown relative mr-3 sm:mr-5" data-placement="top-end">
                            <a href="javascript:;" class="text-gray-600 hover:text-theme-1 dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block"> <i data-feather="smile" class="w-full h-full"></i> </a>
                                    ...
                                    <div class="chat-input__smiley__box flex flex-col pb-3 -mt-2">
                                        <div class="px-3 pt-5">
                                            <div class="relative">
                                                ...
                                                <i class="w-5 h-5 absolute my-auto inset-y-0 mr-3 right-0" data-feather="search"></i> 
                                            </div>
                                        </div>
                        ...
                        <a href="javascript:;" class="bg-theme-1 text-white w-8 h-8 sm:w-10 sm:h-10 block rounded-full flex-none flex items-center justify-center"> <i data-feather="send" class="w-4 h-4 sm:w-5 sm:h-5"></i> </a>
                    </div>
                    <!-- END: Chat Box Input -->
                </div>
                <!-- END: Chat Box -->
