  ...
  >
    ...
    >
      <div class="flex items-center mr-auto">
        <div class="w-12 h-12 flex-none image-fit mr-1">
          ...
          />
          <div
            class="bg-green-500 w-3 h-3 absolute right-0 top-0 rounded-full border-2 border-white"
          ></div>
        </div>
        ...
        <div class="w-full">
          <div>
            <div class="chat-text-box__content flex items-center float-left">
              ...
              >
                Lorem ipsum sit
                <a class="text-theme-1" href="">@edwardnorton</a> amen dolor,
            ...
            <div class="chat-text-box__content flex items-center float-left">
              <div
                class="box text-gray-700 dark:text-gray-300 flex flex-col sm:flex-row items-center mt-3 p-3"
              >
                <div
                  class="chat-text-box__content__icon text-white w-12 flex-none bg-contain relative bg-no-repeat bg-center block"
                >
                  <div
                    class="absolute m-auto top-0 left-0 right-0 bottom-0 flex items-center justify-center"
                  >
                    JPG
                  </div>
                </div>
                <div class="sm:ml-3 mt-3 sm:mt-0 text-center sm:text-left">
                  <div
                    class="text-gray-700 dark:text-gray-300 whitespace-nowrap font-medium"
                  >
                    preview-8.jpg
                  </div>
                ...
                <div class="sm:ml-20 mt-3 sm:mt-0 flex">
                  <a
                    href="javascript:;"
                    title="Download"
                    class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center sm:ml-2"
                  >
                  ...
                  <a
                    href="javascript:;"
                    title="Share"
                    class="tooltip w-8 h-8 block border rounded-full flex-none flex items-center justify-center ml-2"
                  >
        ...
        <div class="w-full">
          <div>
            ...
            <div class="chat-text-box__content flex items-center float-right">
              ...
              <div
                class="rounded-md text-gray-700 chat-text-box__content__text--image flex justify-end mt-3"
              >
                <div
        ...
        <div class="w-full">
          <div>
            ...
            <div class="chat-text-box__content flex items-center float-right">
              ...
              <div
                class="box leading-relaxed text-gray-700 dark:text-gray-300 flex flex-col sm:flex-row items-center mt-3 p-3"
              >
                <div
                  class="chat-text-box__content__icon text-white w-12 flex-none bg-contain relative bg-no-repeat bg-center block"
                >
    ...
    >
      ...
      <div class="dropdown relative" data-placement="top">
        ...
        <div class="chat-input__dropdown dropdown-menu">
          <div class="dropdown-menu__content p-2">
            <a
              href=""
              class="shadow-md text-gray-600 bg-white rounded-full dark:text-gray-300 dark:bg-dark-3 hover:bg-theme-1 hover:text-white dark:hover:bg-theme-1 flex items-center block p-3 transition duration-300 rounded-md mb-2"
            >
      ...
      <div class="dropdown relative mr-3 sm:mr-5" data-placement="top-end">
        <a
          href="javascript:;"
          class="text-gray-600 hover:text-theme-1 dropdown-toggle w-4 h-4 sm:w-5 sm:h-5 block"
        >
          <i data-feather="smile" class="w-full h-full"></i>
        </a>
        <div class="chat-input__smiley dropdown-menu">
          <div
            class="dropdown-menu__content box dark:text-gray-300 dark:bg-dark-3 shadow-md"
          >
            <div class="chat-input__smiley__box flex flex-col pb-3 -mt-2">
              <div class="px-3 pt-5">
                <div class="relative">
                  <input
                    type="text"
                    class="form-control bg-gray-200 border-transparent pr-10"
              ...
              <div
                class="chat-input__smiley__box__tabs text-gray-600 nav nav-tabs flex px-3 mt-5"
                role="tablist"
              >
                <a
                  data-toggle="tab"
                ...
                >
                  ...
                  >
                    <div class="grid grid-cols-8 text-2xl">
                      <button
                        class="rounded hover:bg-gray-200 dark:hover:bg-dark-2 focus:outline-none"
                      >
                        😀
                      </button>
                      <button
