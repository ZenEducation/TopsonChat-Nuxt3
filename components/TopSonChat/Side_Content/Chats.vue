<template>
  ...
  >
    ...
    <div class="intro-y relative mt-5">
      ...
      <i
        data-feather="search"
        class="text-gray-600 w-5 h-5 absolute inset-y-0 right-0 my-auto mr-3"
      ></i>
    </div>
    <div
      class="intro-y flex-none overflow-x-auto overflow-y-hidden scrollbar-hidden"
    >
      <div class="flex mt-6">
        <a
          href=""
        ...
        >
          ...
          <div
            class="text-gray-600 dark:text-gray-500 truncate text-center mt-2"
          >
            John Travolta
          </div>
        </a>
    ...
    <div class="intro-y overflow-y-auto scrollbar-hidden pt-2 mt-3 -mx-5 px-5">
      <div class="intro-x">
        <div class="zoom-in">
          <div
            class="chat-list box cursor-pointer relative flex items-center px-4 py-3 bg-theme-1 dark:bg-theme-1"
          >
            ...
            <div class="flex flex-col">
              <div class="whitespace-nowrap text-opacity-80 text-xs text-white">
                03:20 PM
              </div>
              <div
      ...
      <div class="intro-x">
        <div class="zoom-in">
          <div
            class="chat-list box cursor-pointer relative flex items-center px-4 py-3 mt-4"
          >
            <div class="w-12 h-12 flex-none image-fit mr-1">
              <img
                alt="Topson Messenger Tailwind HTML Admin Template"
            ...
            <div class="ml-2 overflow-hidden">
              ...
              >
              <div
                class="text-opacity-80 w-4/5 truncate mt-0.5 text-gray-800 dark:text-gray-500"
              >
            ...
            <div class="flex flex-col">
              <div
                class="whitespace-nowrap text-opacity-80 text-xs text-gray-800 dark:text-gray-600"
              >
                01:10 PM
              </div>
              <div
