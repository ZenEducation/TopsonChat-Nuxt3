<template>
  ...
  <div
    class="info-content col-span-12 xl:col-span-3 flex flex-col overflow-hidden pl-6 xl:pl-0 pr-6"
  >
    <div class="overflow-y-auto scrollbar-hidden py-6">
      ...
      <div class="intro-y box relative px-4 py-6">
        <a
          href="javascript:;"
          title="Settings"
          class="text-gray-600 tooltip w-8 h-8 block flex items-center justify-center absolute top-0 right-0 mr-1 mt-1"
        >
        ...
        <div class="w-20 h-20 mx-auto image-fit">
          ...
          />
          <div
            class="bg-green-500 border-white w-3 h-3 absolute right-0 top-0 mt-1 mr-1 rounded-full border-2"
          ></div>
        </div>
      ...
      <div class="intro-y box p-4 mt-3">
        ...
        <div class="mt-4">
          <div
            class="border-gray-200 dark:border-dark-5 flex items-center border-b pb-3"
          >
            <div class="">
...
<!-- start -->
          ...
          >
            <div
              class="shared-file__icon text-white w-12 flex-none bg-contain relative bg-no-repeat bg-center block"
            >
              <div
