    ...
    <div class="w-full md:w-full lg:w-3/4 p-6 mx-auto">
      ...
      <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-6">
          <div class="intro-y box p-4">
            ...
            <div class="mt-3">
              ...
              <input type="text" class="form-control" id="setting-form-2" />
            </div>
            <div class="mt-3">
              <label for="setting-form-3" class="form-label">Phone</label>
              <input type="text" class="form-control" id="setting-form-3" />
            </div>
            <div class="mt-3">
              <label for="setting-form-4" class="form-label">Email</label>
              <input type="text" class="form-control" id="setting-form-4" />
            </div>
            <div class="mt-3">
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
          <div class="intro-y box p-4">
            <div class="mt-3">
              <label for="change-password-1" class="form-label"
            ...
            <div class="mt-3">
              <label for="change-password-2" class="form-label"
                >New Password</label
              >
              <input
                type="text"
            ...
            <div class="mt-3">
              <label for="change-password-3" class="form-label"
            ...
            <button class="btn btn-primary w-full mt-4">Change Password</button>
          </div>
          <div class="intro-y box p-4 mt-5">
            <div>
              <label for="social-media-form-1" class="form-label"
                >Twitter</label
              >
              <div class="input-group">
                <div class="input-group-text">
                  <i data-feather="twitter" class="w-4 h-4 mt-0.5"></i>
                </div>
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="mt-3">
              <label for="social-media-form-2" class="form-label"
                >Facebook</label
              >
              <div class="input-group">
                <div class="input-group-text">
                  <i data-feather="facebook" class="w-4 h-4 mt-0.5"></i>
                </div>
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="mt-3">
              <label for="social-media-form-3" class="form-label"
                >Instagram</label
              >
              <div class="input-group">
                <div class="input-group-text">
                  <i data-feather="instagram" class="w-4 h-4 mt-0.5"></i>
                </div>
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="mt-3">
              ...
              <div class="input-group">
                <div class="input-group-text">
                  <i data-feather="github" class="w-4 h-4 mt-0.5"></i>
                </div>
                <input
                  type="text"
                  class="form-control"
            ...
            <div class="mt-3">
              ...
              <div class="input-group">
                <div class="input-group-text">
                  <i data-feather="slack" class="w-4 h-4 mt-0.5"></i>
                </div>
                <input
                  type="text"
                  class="form-control"
