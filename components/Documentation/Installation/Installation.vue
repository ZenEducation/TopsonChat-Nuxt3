    ...
    <div class="col-span-9 border-l border-gray-800 bg-gray-900 py-10 px-10">
      ...
      <div class="intro-y leading-relaxed">
        ...
        <ul class="list-decimal ml-6">
          ...
          <li class="mt-4">
            Run
            <span class="text-yellow-500 font-medium">yarn run watch</span> to
            start compiling assets or
            <span class="text-yellow-500 font-medium">yarn run dev</span> for
            production use.
          </li>
          <li class="mt-4">The template is ready to use!</li>
        </ul>
      </div>
    </div>
  </div>
