<template>
  ...
  <div class="top-bar top-0 left-0 fixed w-full h-16">
    ...
    >
      <!-- BEGIN: Logo -->
      <a
        class="hidden md:flex items-center h-full mr-auto"
      ...
      <div class="account-dropdown dropdown relative">
        ...
        >
          ...
          <div class="hidden md:block ml-3">
            <div class="w-28 truncate font-medium leading-tight">
              Keanu Reeves
            </div>
            <div class="account-dropdown__info text-xs text-gray-600">
              Frontend Engineer
            </div>
          </div>
        </a>
  ...
  <div
    class="modal-invite-friends modal"
                  ...
                  >
                    ...
                    <div class="ml-2 overflow-hidden">
                      ...
                      <div class="flex items-center text-xs">
                        <div
                          class="text-gray-600 whitespace-nowrap text-xs mt-0.5"
                        >
                          Last seen 14 seconds ago ago
                        </div>
                      </div>
                    </div>
                    <input
  ...
  <div class="side-menu hidden md:block top-0 left-0 fixed w-16 h-screen">
    ...
    >
      ...
      <a
        ...
        title="Settings"
      >
        <i data-feather="settings" class="w-5 h-5 mx-auto"></i>
      </a>
    </div>
  </div>
  <!-- END: Side Menu -->
    ...
    >
      ...
      >
        ...
        <div class="intro-y box relative px-4 py-6 mt-5">
          ...
          <div class="text-base font-medium text-center mt-3">
            John Travolta
          </div>
          <div class="text-gray-600 text-center text-xs uppercase mt-0.5">
            Software Engineer
          </div>
        </div>
        <div class="intro-y box p-4 mt-3">
          ...
          <div
            class="border-gray-200 dark:border-dark-5 flex items-center py-3"
          >
            <div class="">
        ...
        <div class="intro-y box p-4 mt-3">
          ...
          >
            ...
            <i data-feather="twitter" class="w-4 h-4 text-gray-600 ml-auto"></i>
          </div>
          <div
            class="
              border-gray-200
      ...
      >
        ...
        <div class="intro-y relative mt-5 mb-6">
          <input
            type="text"
            class="form-control box py-3 px-4 border-transparent pr-8"
                ...
                >
                  ...
                  <div class="ml-2 overflow-hidden">
                    ...
                    <div class="flex items-center text-xs mt-0.5">
                      <div class="text-gray-600 dark:text-gray-500 truncate">
              ...
              <div class="intro-x block">
                ...
                >
                  ...
                  <div
                    ...
                    "
                  >
                    <a class="dropdown-toggle w-4 h-4" href="javascript:;">
                      <i data-feather="more-vertical" class="w-4 h-4"></i>
                    </a>
                    <div class="dropdown-menu w-40">
                      <div
      ...
      >
        ...
        >
          <div class="flex mt-6">
            <a
              href=""
              class="w-12 mr-3 cursor-pointer tooltip"
              title="John Travolta"
            >
          ...
          <div class="intro-x">
            <div class="zoom-in">
              ...
              >
                ...
                <div class="ml-2 overflow-hidden">
                  <a href="javascript:;" class="font-medium text-white"
                    >John Travolta</a
                  >
                ...
                <div class="flex flex-col">
                  <div
                    class="whitespace-nowrap text-opacity-80 text-xs text-white"
                  >
                    03:20 PM
                  </div>
                  <div
                  ...
                  >
                    <a
                      class="dropdown-toggle block text-opacity-70 text-white"
                      href="javascript:;"
                    >
              ...
              >
                ...
                <div class="flex flex-col">
                  <div
                    class="
                      whitespace-nowrap
                      text-opacity-80 text-xs text-gray-800
                      dark:text-gray-600
                    "
                  >
                    01:10 PM
      ...
      >
        ...
        <div class="intro-y box p-2 mt-5 mb-6">
          <div
            class="boxed-tabs nav nav-tabs justify-center flex"
            role="tablist"
          >
            <a
              data-toggle="tab"
          ...
          <div class="tab-content">
            ...
            >
              <div class="box p-4 mt-3 mb-6">
                <div>
                  <label for="create-group-form-1" class="form-label"
                    >Photo</label
                  >
                  <div
                    class="
                  ...
                  >
                    ...
                    <div class="image-upload__info mt-2">
                ...
                <div class="mt-3">
                  <label for="create-group-form-2" class="form-label"
                    >Group Name</label
                  >
                  <input
                    type="text"
                ...
                <div class="mt-3">
                  <label for="create-group-form-3" class="form-label"
                    >Tagline</label
                  >
                  <input
                    type="text"
                ...
                <div class="mt-3">
                  <label for="create-group-form-4" class="form-label"
                    >Public</label
                  >
                ...
                <div class="mt-3">
                  <label for="create-group-form-5" class="form-label"
                    >Description</label
                  >
                  <textarea
                    class="form-control"
      ...
      >
        ...
        >
          <div class="flex items-center mr-auto">
            ...
            <div class="ml-2 overflow-hidden">
              <a href="javascript:;" class="text-base font-medium"
                >John Travolta</a
              >
        ...
        <div class="overflow-y-scroll scrollbar-hidden pt-5 flex-1">
          ...
          <div class="-intro-x chat-text-box flex items-end float-left mb-4">
            ...
            <div class="w-full">
              <div>
                <div
                  class="chat-text-box__content flex items-center float-left"
                >
                  <div
                    class="
                      box
                  ...
                  >
                    Lorem ipsum sit
                    <a class="text-theme-1" href="">@edwardnorton</a> amen
          ...
          <div class="intro-x chat-text-box flex items-end float-right mb-4">
            <div class="w-full">
              <div>
                <div
                  class="chat-text-box__content flex items-center float-right"
                >
                  ...
                  >
                    Lorem ipsum sit
                    <a class="text-white" href="">@morganfreeman</a> amen dolor,
                    lorem ipsum sit amen dolor
                  </div>
                </div>
                <div class="clear-both"></div>
                <div
                ...
                >
                  ...
                  <div
                    class="
                      rounded-md
                      text-gray-700
                      chat-text-box__content__text--image
                      flex
                      justify-end
                      mt-3
                    "
                  >
                    <div
                      class="tooltip w-16 h-16 image-fit zoom-in"
                      title="preview-4.jpg"
                    >
                      <img
                        alt="Topson Messenger Tailwind HTML Admin Template"
                    ...
                    <div
                      class="tooltip w-16 h-16 image-fit ml-2 zoom-in"
                      title="preview-4.jpg"
                    >
                      <img
                        alt="Topson Messenger Tailwind HTML Admin Template"
          ...
          <!-- END: Chat Text -->
          <div class="clear-both"></div>
          <div class="intro-y text-gray-500 text-xs text-center mb-6 mt-5">
            12 June 2020
          </div>
          <!-- BEGIN: Chat Text -->
          <div class="-intro-x chat-text-box flex items-end float-left mb-4">
        ...
        >
          ...
          <div class="dropdown relative" data-placement="top">
            <a
              href="javascript:;"
              class="text-gray-600 hover:text-theme-1 dropdown-toggle"
            >
              ...
              <div class="dropdown-menu__content p-2">
                <a
                  ...
                  class="
                    ...
                    bg-white
                    rounded-full
                    dark:text-gray-300 dark:bg-dark-3
                    hover:bg-theme-1 hover:text-white
                    dark:hover:bg-theme-1
                    flex
                    items-center
                    block
                    p-3
                ...
                <div class="chat-input__smiley__box flex flex-col pb-3 -mt-2">
                  <div class="px-3 pt-5">
                    <div class="relative">
                      ...
                      />
                      <i
                        class="w-5 h-5 absolute my-auto inset-y-0 mr-3 right-0"
                        data-feather="search"
                      ></i>
                    </div>
                  </div>
          ...
          <a
            ...
            "
          >
            <i data-feather="send" class="w-4 h-4 sm:w-5 sm:h-5"></i>
          </a>
        </div>
        <!-- END: Chat Box Input -->
      </div>
      ...
      >
        <div class="overflow-y-auto scrollbar-hidden py-6">
          ...
          <div class="intro-y h-full box flex flex-col p-4 mt-3">
            ...
            <div
              class="mt-4 overflow-x-hidden overflow-y-auto scrollbar-hidden"
            >
              <div
                class="
                  shared-file
              ...
              >
                ...
                <div class="w-full ml-3">
                  ...
                  <div class="text-gray-600 whitespace-nowrap text-xs mt-0.5">
                    1.2 MB Image File
                  </div>
                </div>
                <div
